...
from .py3compat import bchr, bord, tobytes, tostr, iter_range

from . import Random
from . import PKCS8, PEM
from . import SHA256
from .asn1 import (
...
from .Primality import (test_probable_prime, COMPOSITE,
                                   PROBABLY_PRIME)
...
class DsaKey(object):
        ...
        Args:
          ...
          protection (string):
            *Only in combination with a pass phrase*.
            ...
            the private DSA key.
            For a complete list of algorithms, see :mod:`.PKCS8`.
          ...
          randfunc (callable):
            ...
            By default it is :func:`.Random.get_random_bytes`.
    ...
    def sign(self, M, K):
        raise NotImplementedError("Use module .DSS instead")
...
def generate(bits, randfunc=None, domain=None):
    ...
    Args:
      ...
      randfunc (callable):
        ...
        If not specified, :func:`.Random.get_random_bytes` is used.
