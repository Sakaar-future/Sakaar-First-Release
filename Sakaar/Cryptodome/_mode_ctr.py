...
from .py3compat import _copy_bytes, is_native_int
from .number import long_to_bytes

raw_ctr_lib = load_pycryptodome_raw_lib("._raw_ctr", """
...
def _create_ctr_cipher(factory, **kwargs):
    ...
    :Parameters:
      factory : module
        The underlying block cipher, a module from ``.``.
    ...
    :Keywords:
      ...
      counter : object
        Instance of ``.Counter``, which allows full customization
